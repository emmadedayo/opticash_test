...
import 'package:opticash/logic/http_service/result_item.dart';
import 'package:opticash/logic/repositories/auth_repository.dart';
...
class AuthProvider {
  ...
  Future<ResultItem<UserModel?>> auth(maps) async {
    ...
    if (map.isNotEmpty && map['data'] != null) {
      try {
        user = UserModel.fromJson(map['data']['user']);
